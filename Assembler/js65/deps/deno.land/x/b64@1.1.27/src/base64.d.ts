...
export namespace base64 {
     ...
     */
    export function toArrayBuffer(data: string, urlMode?: boolean | undefined): ArrayBuffer;
    /**
     ...
     */
    export function fromArrayBuffer(arrBuf: ArrayBuffer, urlMode?: boolean | undefined): string;
    /**
     ...
     */
    export function toString(str: string, urlMode?: boolean | undefined): string;
    /**
     ...
     */
    export function fromString(str: string, urlMode?: boolean | undefined): string;
    /**
     ...
     */
    export function validate(encoded: string, urlMode?: boolean | undefined): boolean;
    export { base64 };
}
