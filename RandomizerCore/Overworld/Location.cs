...
public class Location
{
    ...
    */
    ...
    public Location(Location clone) : this(clone.YRaw, clone.Xpos, clone.MemAddress, clone.Map, clone.Continent)
    {
        ...
        IsSecondPartOfCave = clone.IsSecondPartOfCave;
        Xpos = clone.Xpos;
    ...
    public byte[] GetLocationBytes()
    {
        ...
        bytes[1] = (byte)((Appear2LowerUponExit ? 128 : 0) + (IsSecondPartOfCave ? 64 : 0) + Xpos);
    ...
    public void Clear()
    {
        ...
        YRaw = 0;
        Xpos = 0;
        Appear2LowerUponExit = false;
        IsSecondPartOfCave = false;
        CanShuffle = false;
    }
}
