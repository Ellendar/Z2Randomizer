...
public class Shuffler
{
    ...
    public List<Palace> CreatePalaces(BackgroundWorker worker)
    {
        ...
        {
            palaces[0].ShuffleSmallItems(4, true, R, props.shuffleSmallItems, props.extraKeys, props.palaceStyle == PalaceStyle.RECONSTRUCTED);
            palaces[1].ShuffleSmallItems(4, true, R, props.shuffleSmallItems, props.extraKeys, props.palaceStyle == PalaceStyle.RECONSTRUCTED);
            palaces[2].ShuffleSmallItems(4, false, R, props.shuffleSmallItems, props.extraKeys, props.palaceStyle == PalaceStyle.RECONSTRUCTED);
            palaces[3].ShuffleSmallItems(4, false, R, props.shuffleSmallItems, props.extraKeys, props.palaceStyle == PalaceStyle.RECONSTRUCTED);
            palaces[4].ShuffleSmallItems(4, true, R, props.shuffleSmallItems, props.extraKeys, props.palaceStyle == PalaceStyle.RECONSTRUCTED);
            palaces[5].ShuffleSmallItems(4, false, R, props.shuffleSmallItems, props.extraKeys, props.palaceStyle == PalaceStyle.RECONSTRUCTED);
            palaces[6].ShuffleSmallItems(5, true, R, props.shuffleSmallItems, props.extraKeys, props.palaceStyle == PalaceStyle.RECONSTRUCTED);
        }
        return palaces;
    }
